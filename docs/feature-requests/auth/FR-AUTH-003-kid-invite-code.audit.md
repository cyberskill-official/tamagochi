...
- "No public social sign-in" rule + binary-level enforcement (FR-LEGAL-003 §1.10) make the kids SKU defensibly COPPA-compliant.
...
`score_post_revision_2: 10/10` — accept. This FR completes the AUTH slice. Combined with FR-AUTH-001 + FR-AUTH-002, every authentication scenario is covered: consumer adults (Apple/Google/Zalo), VN adults (Zalo-primary), and under-13 children (invite code + Safe Harbor parental consent + color/animal PIN).
