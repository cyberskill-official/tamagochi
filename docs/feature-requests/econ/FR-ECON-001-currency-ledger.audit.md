...
- **ISS-007 (warning) IAP forgery → Hearts grant.** Round-2. **RESOLVED §10 row 9** — FR-ECON-002 validation.
...
`score_post_revision_2: 10/10` — accept. FR-ECON-002/003/SUB-001/ADS-001/VIRAL-004 build on this.
