...
- **ISS-003 (warning) Locale QA gap for new I18N language launches.** Round-2 noted §1.11 covered current languages but did not gate adding a new language. **RESOLVED §10 row 11** — new-language launch requires gate translation before release; the I18N FR's pre-launch checklist tracks this.
...
`score_post_revision_2: 10/10` — accept. This FR completes the LEGAL trio (FR-LEGAL-001 + 002 + 003) and is the gating substrate for kids-SKU submission. FR-ADS-002, FR-SUB-002, FR-VIRAL-005 can now begin authoring once this is shipped.
