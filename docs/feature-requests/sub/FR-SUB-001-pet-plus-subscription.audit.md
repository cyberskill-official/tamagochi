...
Pet+ at $4.99/mo or $39.99/yr (VN ₫99K/₫799K) via Apple/Google subscriptions, 16-day grace period, Apple ASSN V2 + Google RTDN webhooks with dedupe, restore-purchase, Family Sharing, monthly 100 Hearts grant, seasonal pet rotation, kids cannot subscribe (Family tier path via FR-SUB-002). 6 ISS resolved → 10/10.
...
`score_post_revision_2: 10/10` — accept. FR-SUB-002 Family tier extends this.
