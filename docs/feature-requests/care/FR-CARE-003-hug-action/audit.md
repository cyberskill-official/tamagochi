...
- **ISS-006 (info) Wedding-ceremony bonus path.** Round-2: FR-SOCIAL-004 wedding might want a hug bonus. **RESOLVED §10 row 7** — handled via FR-SOCIAL-004 separate path, not this FR.
...
- AI surface integration sets up FR-AI-001 dialogue richness.
