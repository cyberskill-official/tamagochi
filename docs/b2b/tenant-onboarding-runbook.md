# TenantOnboardingRunbook

## Purpose

This media artifact documents the operational behavior, policy boundary, and verification surface for `docs/b2b/tenant-onboarding-runbook.md`.
