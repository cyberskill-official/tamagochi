# TechcombankIntegrationSpec

## Purpose

This tenant artifact documents the operational behavior, policy boundary, and verification surface for `docs/b2b/techcombank-integration-spec.md`.
