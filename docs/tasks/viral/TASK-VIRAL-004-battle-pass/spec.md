...
created: 2026-05-17
shipped: 2026-05-17
related_frs: [TASK-ECON-001, TASK-ECON-002, TASK-SUB-001, TASK-CARE-005, TASK-LEGAL-002, TASK-OBS-001, TASK-INFRA-003, TASK-AUTH-003]
depends_on: [TASK-ECON-002, TASK-SUB-001, TASK-CARE-005]
blocks: []
effort_hours: 12
new_files:
...
allowed_tools:
  ...
  - "TASK-ECON-001 + TASK-ECON-002 for Coins/Hearts grants"
disallowed_tools:
  - "Real-money randomised reward inside any tier (TASK-LEGAL-002)"
  - "Mystery tier rewards (deterministic disclosure required)"
  - "Battle pass for kids SKU without parental approval (TASK-SUB-002)"
...
§1.2  **Tier rewards — disclosed at season start.** Every tier's reward is known before the player buys premium. Per TASK-LEGAL-002 §1.7. NO mystery tiers.
...
§1.5  **Premium purchase.** Player taps "Unlock Premium" → IAP via TASK-ECON-002 (`mochi.battle_pass.season_N`). On valid receipt → premium track unlocked + retroactively grants premium-only rewards for tiers already earned.

§1.6  **Bundle with Family.** Family tier subscribers (TASK-SUB-002) get premium track included for all child profiles.
...
§1.16  **Kids SKU disabled.** Per TASK-SUB-002 — kids battle pass via Family tier only. No independent purchase.

§1.17  **Tenant-aware seasons.** B2B tenants (TASK-B2B-001) can have their own seasons with own reward tracks.

§1.18  **DPO-reviewed objectives.** All objective copy reviewed for kid-appropriateness + cultural sensitivity.

§1.19  **Localised season copy** per TASK-I18N-001.

§1.20  **Analytics.** `viral.bp.season_start`, `viral.bp.tier_progressed`, `viral.bp.premium_purchased`, `viral.bp.reward_claimed`, `viral.bp.season_ended` per TASK-OBS-001.
...
**Why disclosed rewards.** Plan §PART 8 + TASK-LEGAL-002 — mystery rewards are loot-box-adjacent.
...
```typescript
describe('TASK-VIRAL-004 — battle pass', () => {
...
| 7 | Mid-season pricing changed | Apple/Google block | Submission refused | task amendment |
...
**Cross-reference:** TASK-ECON-002, TASK-SUB-001/002, TASK-CARE-005.
