...
**State:** Completed **Reason:** Completed with mock/sandbox validation; production gate: Apple/Google/Antom/Xsolla receipts require merchant sandbox credentials. Receipt-prefix sandbox validation is used locally. **Deliverables checked:** 12 **Missing deliverables:** 0 **Scaffold deliverables:** 0
