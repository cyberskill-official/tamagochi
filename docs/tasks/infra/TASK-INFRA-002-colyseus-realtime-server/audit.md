...
- `crypto.randomBytes()` for state-affecting RNG enforced via ESLint (TASK-LEGAL-002 compliance survives team turnover).
...
`score_post_revision_2: 10/10` — accept. This task + TASK-INFRA-001 + TASK-INFRA-003 form the P0 INFRA trio. PetRoom in §6 is the substrate for every state-affecting gameplay task (TASK-CARE-001..005, TASK-SOCIAL-001..004, TASK-AI-001, TASK-VIRAL-002).
