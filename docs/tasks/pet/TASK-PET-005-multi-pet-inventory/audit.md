...
- **ISS-006 (warning) Offspring grace period.** Round-2: TASK-PET-007 dependency. **RESOLVED §1.17 + §10 row 8** — cron job moves pending eggs.

## §4 — Strengths preserved

- DB trigger + app-layer = defense in depth.
- Downgrade-keeps-existing aligns with Apple/Google patterns.
- No individual-slot IAP keeps TASK-LEGAL-002 clean.
...
`score_post_revision_2: 10/10` — accept. TASK-PET-006/007/008 + TASK-SOCIAL-003 now have inventory substrate.
