...
- VN-specific primary CTA via locale config (TASK-I18N-001 cross-reference).
- PDPL data-processing addendum cited in the public privacy policy — auditor-friendly.

## §5 — Resolution

`score_post_revision_2: 10/10` — accept. Completes the consumer-SKU provider trio (TASK-AUTH-001 + TASK-AUTH-002 + the under-13 path in TASK-AUTH-003).
