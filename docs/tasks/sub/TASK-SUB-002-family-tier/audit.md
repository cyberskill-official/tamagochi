...
Family tier $9.99/mo for up to 5 children + parental dashboard, screen-time cap, spend cap with parental approval push, content filter override, cross-SKU family link (parent standard + children kids project), VPC per child via TASK-AUTH-003, DSR cascade. 6 ISS resolved → 10/10.
