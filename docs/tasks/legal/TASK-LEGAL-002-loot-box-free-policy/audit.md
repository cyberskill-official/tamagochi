...
- The cross-reference at §11 to downstream tasks is explicit — TASK-PET-006/007/008, TASK-ECON-002, TASK-VIRAL-004 cannot proceed coherently without this spec.

## §5 — Resolution

`score_post_revision_2: 10/10` — accept. Ship verdict: TASK-LEGAL-002 locks the monetisation regulatory envelope for the entire project. Without it, TASK-PET-006 (rarity tiers), TASK-PET-008 (Permadeath-Lite revival), TASK-ECON-002 (IAP catalogue), and TASK-VIRAL-004 (battle pass) cannot be coherently authored.
