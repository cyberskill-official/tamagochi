# ExternalLinkGatePolicy

## Purpose

This compliance artifact documents the operational behavior, policy boundary, and verification surface for `docs/legal/external-link-gate-policy.md`.
