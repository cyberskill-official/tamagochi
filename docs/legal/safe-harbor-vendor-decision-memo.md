# SafeHarborVendorDecisionMemo

## Purpose

This compliance artifact documents the operational behavior, policy boundary, and verification surface for `docs/legal/safe-harbor-vendor-decision-memo.md`.
