export type GrandmaWatchServiceDecision = {
  allowed: boolean;
  reason: string;
  auditEvent: string;
  tenantId: string;
...
export class GrandmaWatchService {
  ...
  evaluate(input: { tenantId?: string; audience?: '13+' | 'under-13'; enabled?: boolean; unsafe?: boolean }): GrandmaWatchServiceDecision {
...
export const grandmaWatchService = new GrandmaWatchService();
