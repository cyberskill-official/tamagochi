export type NameContentSafetyServiceDecision = {
  allowed: boolean;
  reason: string;
  auditEvent: string;
  tenantId: string;
...
export class NameContentSafetyService {
  ...
  evaluate(input: { tenantId?: string; audience?: '13+' | 'under-13'; enabled?: boolean; unsafe?: boolean }): NameContentSafetyServiceDecision {
...
export const nameContentSafetyService = new NameContentSafetyService();
