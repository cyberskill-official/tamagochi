export type SlotEntitlementServiceDecision = {
  allowed: boolean;
  reason: string;
  auditEvent: string;
  tenantId: string;
...
export class SlotEntitlementService {
  ...
  evaluate(input: { tenantId?: string; audience?: '13+' | 'under-13'; enabled?: boolean; unsafe?: boolean }): SlotEntitlementServiceDecision {
...
export const slotEntitlementService = new SlotEntitlementService();
