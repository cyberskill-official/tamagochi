export type RarityAcquisitionServiceDecision = {
  allowed: boolean;
  reason: string;
  auditEvent: string;
  tenantId: string;
...
export class RarityAcquisitionService {
  ...
  evaluate(input: { tenantId?: string; audience?: '13+' | 'under-13'; enabled?: boolean; unsafe?: boolean }): RarityAcquisitionServiceDecision {
...
export const rarityAcquisitionService = new RarityAcquisitionService();
