export type ImpossibleStateMonitorDecision = {
  allowed: boolean;
  reason: string;
  auditEvent: string;
  tenantId: string;
...
export class ImpossibleStateMonitor {
  ...
  evaluate(input: { tenantId?: string; audience?: '13+' | 'under-13'; enabled?: boolean; unsafe?: boolean }): ImpossibleStateMonitorDecision {
...
export const impossibleStateMonitor = new ImpossibleStateMonitor();
