export type BanDecisionSpecDecision = {
  allowed: boolean;
  reason: string;
  auditEvent: string;
  tenantId: string;
...
export class BanDecisionSpec {
  readonly kind = 'observability';

  evaluate(input: { tenantId?: string; audience?: '13+' | 'under-13'; enabled?: boolean; unsafe?: boolean }): BanDecisionSpecDecision {
...
export const banDecisionSpec = new BanDecisionSpec();
