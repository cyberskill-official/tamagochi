export type ApplovinValidatorDecision = {
  allowed: boolean;
  reason: string;
  auditEvent: string;
  tenantId: string;
...
export class ApplovinValidator {
  readonly kind = 'economy';

  evaluate(input: { tenantId?: string; audience?: '13+' | 'under-13'; enabled?: boolean; unsafe?: boolean }): ApplovinValidatorDecision {
...
export const applovinValidator = new ApplovinValidator();
