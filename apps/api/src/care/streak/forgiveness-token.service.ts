export type ForgivenessTokenServiceDecision = {
  allowed: boolean;
  reason: string;
  auditEvent: string;
  tenantId: string;
...
export class ForgivenessTokenService {
  ...
  evaluate(input: { tenantId?: string; audience?: '13+' | 'under-13'; enabled?: boolean; unsafe?: boolean }): ForgivenessTokenServiceDecision {
...
export const forgivenessTokenService = new ForgivenessTokenService();
