export type SoapCatalogueDecision = {
  allowed: boolean;
  reason: string;
  auditEvent: string;
  tenantId: string;
...
export class SoapCatalogue {
  readonly kind = 'care';

  evaluate(input: { tenantId?: string; audience?: '13+' | 'under-13'; enabled?: boolean; unsafe?: boolean }): SoapCatalogueDecision {
...
export const soapCatalogue = new SoapCatalogue();
