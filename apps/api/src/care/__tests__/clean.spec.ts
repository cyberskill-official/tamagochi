...
export class CleanSpec {
  readonly kind = 'care';

  evaluate(input: { tenantId?: string; audience?: '13+' | 'under-13'; enabled?: boolean; unsafe?: boolean }): CleanSpecDecision {
...
export const cleanSpec = new CleanSpec();
