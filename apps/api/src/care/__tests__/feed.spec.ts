...
export class FeedSpec {
  readonly kind = 'care';

  evaluate(input: { tenantId?: string; audience?: '13+' | 'under-13'; enabled?: boolean; unsafe?: boolean }): FeedSpecDecision {
...
export const feedSpec = new FeedSpec();
