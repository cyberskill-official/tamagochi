export type RandomisationDisclosureSpecDecision = {
  allowed: boolean;
  reason: string;
  auditEvent: string;
  tenantId: string;
...
export class RandomisationDisclosureSpec {
  readonly kind = 'compliance';

  evaluate(input: { tenantId?: string; audience?: '13+' | 'under-13'; enabled?: boolean; unsafe?: boolean }): RandomisationDisclosureSpecDecision {
...
export const randomisationDisclosureSpec = new RandomisationDisclosureSpec();
