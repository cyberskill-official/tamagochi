export type CoppaAgeGateSpecDecision = {
  allowed: boolean;
  reason: string;
  auditEvent: string;
  tenantId: string;
...
export class CoppaAgeGateSpec {
  readonly kind = 'compliance';

  evaluate(input: { tenantId?: string; audience?: '13+' | 'under-13'; enabled?: boolean; unsafe?: boolean }): CoppaAgeGateSpecDecision {
...
export const coppaAgeGateSpec = new CoppaAgeGateSpec();
