export type CoppaAgeGateMiddlewareDecision = {
  allowed: boolean;
  reason: string;
  auditEvent: string;
  tenantId: string;
...
export class CoppaAgeGateMiddleware {
  readonly kind = 'compliance';

  evaluate(input: { tenantId?: string; audience?: '13+' | 'under-13'; enabled?: boolean; unsafe?: boolean }): CoppaAgeGateMiddlewareDecision {
...
export const coppaAgeGateMiddleware = new CoppaAgeGateMiddleware();
