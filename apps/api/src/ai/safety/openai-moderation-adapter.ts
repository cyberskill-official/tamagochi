export type OpenaiModerationAdapterDecision = {
  allowed: boolean;
  reason: string;
  auditEvent: string;
  tenantId: string;
...
export class OpenaiModerationAdapter {
  ...
  evaluate(input: { tenantId?: string; audience?: '13+' | 'under-13'; enabled?: boolean; unsafe?: boolean }): OpenaiModerationAdapterDecision {
...
export const openaiModerationAdapter = new OpenaiModerationAdapter();
