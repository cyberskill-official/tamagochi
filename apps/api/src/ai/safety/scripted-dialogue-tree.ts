export type ScriptedDialogueTreeDecision = {
  allowed: boolean;
  reason: string;
  auditEvent: string;
  tenantId: string;
...
export class ScriptedDialogueTree {
  ...
  evaluate(input: { tenantId?: string; audience?: '13+' | 'under-13'; enabled?: boolean; unsafe?: boolean }): ScriptedDialogueTreeDecision {
...
export const scriptedDialogueTree = new ScriptedDialogueTree();
