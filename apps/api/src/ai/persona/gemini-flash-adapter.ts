export type GeminiFlashAdapterDecision = {
  allowed: boolean;
  reason: string;
  auditEvent: string;
  tenantId: string;
...
export class GeminiFlashAdapter {
  ...
  evaluate(input: { tenantId?: string; audience?: '13+' | 'under-13'; enabled?: boolean; unsafe?: boolean }): GeminiFlashAdapterDecision {
...
export const geminiFlashAdapter = new GeminiFlashAdapter();
