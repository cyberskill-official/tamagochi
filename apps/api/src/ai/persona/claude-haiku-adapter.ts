export type ClaudeHaikuAdapterDecision = {
  allowed: boolean;
  reason: string;
  auditEvent: string;
  tenantId: string;
...
export class ClaudeHaikuAdapter {
  ...
  evaluate(input: { tenantId?: string; audience?: '13+' | 'under-13'; enabled?: boolean; unsafe?: boolean }): ClaudeHaikuAdapterDecision {
...
export const claudeHaikuAdapter = new ClaudeHaikuAdapter();
