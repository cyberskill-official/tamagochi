export type ShareTrackingControllerDecision = {
  allowed: boolean;
  reason: string;
  auditEvent: string;
  tenantId: string;
...
export class ShareTrackingController {
  ...
  evaluate(input: { tenantId?: string; audience?: '13+' | 'under-13'; enabled?: boolean; unsafe?: boolean }): ShareTrackingControllerDecision {
...
export const shareTrackingController = new ShareTrackingController();
