...
export class TradeSpec {
  readonly kind = 'social';

  evaluate(input: { tenantId?: string; audience?: '13+' | 'under-13'; enabled?: boolean; unsafe?: boolean }): TradeSpecDecision {
...
export const tradeSpec = new TradeSpec();
