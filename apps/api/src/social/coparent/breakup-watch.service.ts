export type BreakupWatchServiceDecision = {
  allowed: boolean;
  reason: string;
  auditEvent: string;
  tenantId: string;
...
export class BreakupWatchService {
  ...
  evaluate(input: { tenantId?: string; audience?: '13+' | 'under-13'; enabled?: boolean; unsafe?: boolean }): BreakupWatchServiceDecision {
...
export const breakupWatchService = new BreakupWatchService();
