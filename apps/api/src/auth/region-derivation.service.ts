export type RegionDerivationServiceDecision = {
  allowed: boolean;
  reason: string;
  auditEvent: string;
  tenantId: string;
...
export class RegionDerivationService {
  ...
  evaluate(input: { tenantId?: string; audience?: '13+' | 'under-13'; enabled?: boolean; unsafe?: boolean }): RegionDerivationServiceDecision {
...
export const regionDerivationService = new RegionDerivationService();
