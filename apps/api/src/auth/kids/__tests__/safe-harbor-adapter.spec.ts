export type SafeHarborAdapterSpecDecision = {
  allowed: boolean;
  reason: string;
  auditEvent: string;
  tenantId: string;
...
export class SafeHarborAdapterSpec {
  readonly kind = 'compliance';

  evaluate(input: { tenantId?: string; audience?: '13+' | 'under-13'; enabled?: boolean; unsafe?: boolean }): SafeHarborAdapterSpecDecision {
...
export const safeHarborAdapterSpec = new SafeHarborAdapterSpec();
