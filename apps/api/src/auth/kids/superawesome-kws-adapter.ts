export type SuperawesomeKwsAdapterDecision = {
  allowed: boolean;
  reason: string;
  auditEvent: string;
  tenantId: string;
...
export class SuperawesomeKwsAdapter {
  readonly kind = 'compliance';

  evaluate(input: { tenantId?: string; audience?: '13+' | 'under-13'; enabled?: boolean; unsafe?: boolean }): SuperawesomeKwsAdapterDecision {
...
export const superawesomeKwsAdapter = new SuperawesomeKwsAdapter();
