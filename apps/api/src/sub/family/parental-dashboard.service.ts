export type ParentalDashboardServiceDecision = {
  allowed: boolean;
  reason: string;
  auditEvent: string;
  tenantId: string;
...
export class ParentalDashboardService {
  ...
  evaluate(input: { tenantId?: string; audience?: '13+' | 'under-13'; enabled?: boolean; unsafe?: boolean }): ParentalDashboardServiceDecision {
...
export const parentalDashboardService = new ParentalDashboardService();
