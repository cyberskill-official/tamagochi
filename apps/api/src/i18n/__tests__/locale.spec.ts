export type LocaleSpecDecision = {
  allowed: boolean;
  reason: string;
  auditEvent: string;
  tenantId: string;
...
export class LocaleSpec {
  readonly kind = 'i18n';

  evaluate(input: { tenantId?: string; audience?: '13+' | 'under-13'; enabled?: boolean; unsafe?: boolean }): LocaleSpecDecision {
...
export const localeSpec = new LocaleSpec();
