export type TenantManifestSpecDecision = {
  allowed: boolean;
  reason: string;
  auditEvent: string;
  tenantId: string;
...
export class TenantManifestSpec {
  readonly kind = 'tenant';

  evaluate(input: { tenantId?: string; audience?: '13+' | 'under-13'; enabled?: boolean; unsafe?: boolean }): TenantManifestSpecDecision {
...
export const tenantManifestSpec = new TenantManifestSpec();
