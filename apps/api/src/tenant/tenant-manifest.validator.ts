export type TenantManifestValidatorDecision = {
  allowed: boolean;
  reason: string;
  auditEvent: string;
  tenantId: string;
...
export class TenantManifestValidator {
  ...
  evaluate(input: { tenantId?: string; audience?: '13+' | 'under-13'; enabled?: boolean; unsafe?: boolean }): TenantManifestValidatorDecision {
...
export const tenantManifestValidator = new TenantManifestValidator();
