export type TenantIsolatorServiceDecision = {
  allowed: boolean;
  reason: string;
  auditEvent: string;
  tenantId: string;
...
export class TenantIsolatorService {
  ...
  evaluate(input: { tenantId?: string; audience?: '13+' | 'under-13'; enabled?: boolean; unsafe?: boolean }): TenantIsolatorServiceDecision {
...
export const tenantIsolatorService = new TenantIsolatorService();
