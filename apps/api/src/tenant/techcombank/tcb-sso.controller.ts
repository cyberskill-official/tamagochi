export type TcbSsoControllerDecision = {
  allowed: boolean;
  reason: string;
  auditEvent: string;
  tenantId: string;
...
export class TcbSsoController {
  ...
  evaluate(input: { tenantId?: string; audience?: '13+' | 'under-13'; enabled?: boolean; unsafe?: boolean }): TcbSsoControllerDecision {
...
export const tcbSsoController = new TcbSsoController();
