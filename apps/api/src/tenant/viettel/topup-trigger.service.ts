export type TopupTriggerServiceDecision = {
  allowed: boolean;
  reason: string;
  auditEvent: string;
  tenantId: string;
...
export class TopupTriggerService {
  ...
  evaluate(input: { tenantId?: string; audience?: '13+' | 'under-13'; enabled?: boolean; unsafe?: boolean }): TopupTriggerServiceDecision {
...
export const topupTriggerService = new TopupTriggerService();
