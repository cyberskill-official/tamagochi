export type ViettelSsoControllerDecision = {
  allowed: boolean;
  reason: string;
  auditEvent: string;
  tenantId: string;
...
export class ViettelSsoController {
  ...
  evaluate(input: { tenantId?: string; audience?: '13+' | 'under-13'; enabled?: boolean; unsafe?: boolean }): ViettelSsoControllerDecision {
...
export const viettelSsoController = new ViettelSsoController();
