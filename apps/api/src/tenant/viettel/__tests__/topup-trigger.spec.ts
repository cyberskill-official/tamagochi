export type TopupTriggerSpecDecision = {
  allowed: boolean;
  reason: string;
  auditEvent: string;
  tenantId: string;
...
export class TopupTriggerSpec {
  readonly kind = 'tenant';

  evaluate(input: { tenantId?: string; audience?: '13+' | 'under-13'; enabled?: boolean; unsafe?: boolean }): TopupTriggerSpecDecision {
...
export const topupTriggerSpec = new TopupTriggerSpec();
