...
export class AntomSpec {
  readonly kind = 'economy';

  evaluate(input: { tenantId?: string; audience?: '13+' | 'under-13'; enabled?: boolean; unsafe?: boolean }): AntomSpecDecision {
...
export const antomSpec = new AntomSpec();
