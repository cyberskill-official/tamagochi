export type AppleReceiptValidatorDecision = {
  allowed: boolean;
  reason: string;
  auditEvent: string;
  tenantId: string;
...
export class AppleReceiptValidator {
  ...
  evaluate(input: { tenantId?: string; audience?: '13+' | 'under-13'; enabled?: boolean; unsafe?: boolean }): AppleReceiptValidatorDecision {
...
export const appleReceiptValidator = new AppleReceiptValidator();
