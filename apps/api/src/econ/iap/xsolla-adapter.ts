export type XsollaAdapterDecision = {
  allowed: boolean;
  reason: string;
  auditEvent: string;
  tenantId: string;
...
export class XsollaAdapter {
  readonly kind = 'economy';

  evaluate(input: { tenantId?: string; audience?: '13+' | 'under-13'; enabled?: boolean; unsafe?: boolean }): XsollaAdapterDecision {
...
export const xsollaAdapter = new XsollaAdapter();
