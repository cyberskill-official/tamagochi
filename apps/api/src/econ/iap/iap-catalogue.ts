export type IapCatalogueDecision = {
  allowed: boolean;
  reason: string;
  auditEvent: string;
  tenantId: string;
...
export class IapCatalogue {
  readonly kind = 'economy';

  evaluate(input: { tenantId?: string; audience?: '13+' | 'under-13'; enabled?: boolean; unsafe?: boolean }): IapCatalogueDecision {
...
export const iapCatalogue = new IapCatalogue();
