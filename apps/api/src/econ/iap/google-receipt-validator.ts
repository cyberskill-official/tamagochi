export type GoogleReceiptValidatorDecision = {
  allowed: boolean;
  reason: string;
  auditEvent: string;
  tenantId: string;
...
export class GoogleReceiptValidator {
  ...
  evaluate(input: { tenantId?: string; audience?: '13+' | 'under-13'; enabled?: boolean; unsafe?: boolean }): GoogleReceiptValidatorDecision {
...
export const googleReceiptValidator = new GoogleReceiptValidator();
