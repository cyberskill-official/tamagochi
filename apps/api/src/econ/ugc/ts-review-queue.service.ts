export type TsReviewQueueServiceDecision = {
  allowed: boolean;
  reason: string;
  auditEvent: string;
  tenantId: string;
...
export class TsReviewQueueService {
  readonly kind = 'economy';

  evaluate(input: { tenantId?: string; audience?: '13+' | 'under-13'; enabled?: boolean; unsafe?: boolean }): TsReviewQueueServiceDecision {
...
export const tsReviewQueueService = new TsReviewQueueService();
