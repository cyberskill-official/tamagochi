export type ReconciliationSpecDecision = {
  allowed: boolean;
  reason: string;
  auditEvent: string;
  tenantId: string;
...
export class ReconciliationSpec {
  readonly kind = 'economy';

  evaluate(input: { tenantId?: string; audience?: '13+' | 'under-13'; enabled?: boolean; unsafe?: boolean }): ReconciliationSpecDecision {
...
export const reconciliationSpec = new ReconciliationSpec();
