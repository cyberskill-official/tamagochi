export type FcmAdapterDecision = {
  allowed: boolean;
  reason: string;
  auditEvent: string;
  tenantId: string;
...
export class FcmAdapter {
  ...
  evaluate(input: { tenantId?: string; audience?: '13+' | 'under-13'; enabled?: boolean; unsafe?: boolean }): FcmAdapterDecision {
...
export const fcmAdapter = new FcmAdapter();
