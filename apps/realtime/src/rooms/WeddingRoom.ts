export type WeddingRoomDecision = {
  allowed: boolean;
  reason: string;
  auditEvent: string;
  tenantId: string;
...
export class WeddingRoom {
  readonly kind = 'social';

  evaluate(input: { tenantId?: string; audience?: '13+' | 'under-13'; enabled?: boolean; unsafe?: boolean }): WeddingRoomDecision {
...
export const weddingRoom = new WeddingRoom();
