export type BaseTenantRoomDecision = {
  allowed: boolean;
  reason: string;
  auditEvent: string;
  tenantId: string;
...
export class BaseTenantRoom {
  readonly kind = 'tenant';

  evaluate(input: { tenantId?: string; audience?: '13+' | 'under-13'; enabled?: boolean; unsafe?: boolean }): BaseTenantRoomDecision {
...
export const baseTenantRoom = new BaseTenantRoom();
