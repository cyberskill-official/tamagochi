export type EvolutionHandlerDecision = {
  allowed: boolean;
  reason: string;
  auditEvent: string;
  tenantId: string;
...
export class EvolutionHandler {
  ...
  evaluate(input: { tenantId?: string; audience?: '13+' | 'under-13'; enabled?: boolean; unsafe?: boolean }): EvolutionHandlerDecision {
...
export const evolutionHandler = new EvolutionHandler();
