...
export class HatchRoom {
  readonly kind = 'pet';

  evaluate(input: { tenantId?: string; audience?: '13+' | 'under-13'; enabled?: boolean; unsafe?: boolean }): HatchRoomDecision {
...
export const hatchRoom = new HatchRoom();
