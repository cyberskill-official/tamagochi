...
export class PetRoom {
  ...
  evaluate(input: { tenantId?: string; audience?: '13+' | 'under-13'; enabled?: boolean; unsafe?: boolean }): PetRoomDecision {
...
export const petRoom = new PetRoom();
