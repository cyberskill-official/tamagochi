export type RateLimiterSpecDecision = {
  allowed: boolean;
  reason: string;
  auditEvent: string;
  tenantId: string;
...
export class RateLimiterSpec {
  readonly kind = 'platform';

  evaluate(input: { tenantId?: string; audience?: '13+' | 'under-13'; enabled?: boolean; unsafe?: boolean }): RateLimiterSpecDecision {
...
export const rateLimiterSpec = new RateLimiterSpec();
