export type ZaloWebSignInDecision = {
  allowed: boolean;
  reason: string;
  auditEvent: string;
  tenantId: string;
...
export class ZaloWebSignIn {
  readonly kind = 'auth';

  evaluate(input: { tenantId?: string; audience?: '13+' | 'under-13'; enabled?: boolean; unsafe?: boolean }): ZaloWebSignInDecision {
...
export const zaloWebSignIn = new ZaloWebSignIn();
