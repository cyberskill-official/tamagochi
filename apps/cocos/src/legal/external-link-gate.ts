export type ExternalLinkGateDecision = {
  allowed: boolean;
  reason: string;
  auditEvent: string;
  tenantId: string;
...
export class ExternalLinkGate {
  readonly kind = 'compliance';

  evaluate(input: { tenantId?: string; audience?: '13+' | 'under-13'; enabled?: boolean; unsafe?: boolean }): ExternalLinkGateDecision {
...
export const externalLinkGate = new ExternalLinkGate();
