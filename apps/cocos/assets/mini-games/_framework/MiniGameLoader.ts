export type MiniGameLoaderDecision = {
  allowed: boolean;
  reason: string;
  auditEvent: string;
  tenantId: string;
...
export class MiniGameLoader {
  ...
  evaluate(input: { tenantId?: string; audience?: '13+' | 'under-13'; enabled?: boolean; unsafe?: boolean }): MiniGameLoaderDecision {
...
export const miniGameLoader = new MiniGameLoader();
