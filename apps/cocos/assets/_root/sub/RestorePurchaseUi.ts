export type RestorePurchaseUiDecision = {
  allowed: boolean;
  reason: string;
  auditEvent: string;
  tenantId: string;
...
export class RestorePurchaseUi {
  readonly kind = 'economy';

  evaluate(input: { tenantId?: string; audience?: '13+' | 'under-13'; enabled?: boolean; unsafe?: boolean }): RestorePurchaseUiDecision {
...
export const restorePurchaseUi = new RestorePurchaseUi();
