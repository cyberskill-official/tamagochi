export type ParentalDashboardUiDecision = {
  allowed: boolean;
  reason: string;
  auditEvent: string;
  tenantId: string;
...
export class ParentalDashboardUi {
  readonly kind = 'compliance';

  evaluate(input: { tenantId?: string; audience?: '13+' | 'under-13'; enabled?: boolean; unsafe?: boolean }): ParentalDashboardUiDecision {
...
export const parentalDashboardUi = new ParentalDashboardUi();
