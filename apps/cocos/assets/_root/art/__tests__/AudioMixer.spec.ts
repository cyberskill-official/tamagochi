export type AudioMixerSpecDecision = {
  allowed: boolean;
  reason: string;
  auditEvent: string;
  tenantId: string;
...
export class AudioMixerSpec {
  readonly kind = 'media';

  evaluate(input: { tenantId?: string; audience?: '13+' | 'under-13'; enabled?: boolean; unsafe?: boolean }): AudioMixerSpecDecision {
...
export const audioMixerSpec = new AudioMixerSpec();
