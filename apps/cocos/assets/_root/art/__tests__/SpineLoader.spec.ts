export type SpineLoaderSpecDecision = {
  allowed: boolean;
  reason: string;
  auditEvent: string;
  tenantId: string;
...
export class SpineLoaderSpec {
  readonly kind = 'media';

  evaluate(input: { tenantId?: string; audience?: '13+' | 'under-13'; enabled?: boolean; unsafe?: boolean }): SpineLoaderSpecDecision {
...
export const spineLoaderSpec = new SpineLoaderSpec();
