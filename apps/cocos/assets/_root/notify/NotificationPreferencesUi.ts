export type NotificationPreferencesUiDecision = {
  allowed: boolean;
  reason: string;
  auditEvent: string;
  tenantId: string;
...
export class NotificationPreferencesUi {
  ...
  evaluate(input: { tenantId?: string; audience?: '13+' | 'under-13'; enabled?: boolean; unsafe?: boolean }): NotificationPreferencesUiDecision {
...
export const notificationPreferencesUi = new NotificationPreferencesUi();
