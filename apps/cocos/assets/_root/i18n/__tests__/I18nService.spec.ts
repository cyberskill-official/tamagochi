export type I18nServiceSpecDecision = {
  allowed: boolean;
  reason: string;
  auditEvent: string;
  tenantId: string;
...
export class I18nServiceSpec {
  readonly kind = 'i18n';

  evaluate(input: { tenantId?: string; audience?: '13+' | 'under-13'; enabled?: boolean; unsafe?: boolean }): I18nServiceSpecDecision {
...
export const i18nServiceSpec = new I18nServiceSpec();
