export type AnalyticsSpecDecision = {
  allowed: boolean;
  reason: string;
  auditEvent: string;
  tenantId: string;
...
export class AnalyticsSpec {
  readonly kind = 'observability';

  evaluate(input: { tenantId?: string; audience?: '13+' | 'under-13'; enabled?: boolean; unsafe?: boolean }): AnalyticsSpecDecision {
...
export const analyticsSpec = new AnalyticsSpec();
