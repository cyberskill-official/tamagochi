export type KidsSdkAllowlistSpecDecision = {
  allowed: boolean;
  reason: string;
  auditEvent: string;
  tenantId: string;
...
export class KidsSdkAllowlistSpec {
  readonly kind = 'compliance';

  evaluate(input: { tenantId?: string; audience?: '13+' | 'under-13'; enabled?: boolean; unsafe?: boolean }): KidsSdkAllowlistSpecDecision {
...
export const kidsSdkAllowlistSpec = new KidsSdkAllowlistSpec();
