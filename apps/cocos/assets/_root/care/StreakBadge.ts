export type StreakBadgeDecision = {
  allowed: boolean;
  reason: string;
  auditEvent: string;
  tenantId: string;
...
export class StreakBadge {
  ...
  evaluate(input: { tenantId?: string; audience?: '13+' | 'under-13'; enabled?: boolean; unsafe?: boolean }): StreakBadgeDecision {
...
export const streakBadge = new StreakBadge();
