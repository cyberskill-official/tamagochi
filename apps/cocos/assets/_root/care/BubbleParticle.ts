export type BubbleParticleDecision = {
  allowed: boolean;
  reason: string;
  auditEvent: string;
  tenantId: string;
...
export class BubbleParticle {
  ...
  evaluate(input: { tenantId?: string; audience?: '13+' | 'under-13'; enabled?: boolean; unsafe?: boolean }): BubbleParticleDecision {
...
export const bubbleParticle = new BubbleParticle();
