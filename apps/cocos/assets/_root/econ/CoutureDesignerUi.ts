export type CoutureDesignerUiDecision = {
  allowed: boolean;
  reason: string;
  auditEvent: string;
  tenantId: string;
...
export class CoutureDesignerUi {
  readonly kind = 'economy';

  evaluate(input: { tenantId?: string; audience?: '13+' | 'under-13'; enabled?: boolean; unsafe?: boolean }): CoutureDesignerUiDecision {
...
export const coutureDesignerUi = new CoutureDesignerUi();
