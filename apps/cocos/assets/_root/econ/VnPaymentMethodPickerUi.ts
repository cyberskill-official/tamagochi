export type VnPaymentMethodPickerUiDecision = {
  allowed: boolean;
  reason: string;
  auditEvent: string;
  tenantId: string;
...
export class VnPaymentMethodPickerUi {
  readonly kind = 'economy';

  evaluate(input: { tenantId?: string; audience?: '13+' | 'under-13'; enabled?: boolean; unsafe?: boolean }): VnPaymentMethodPickerUiDecision {
...
export const vnPaymentMethodPickerUi = new VnPaymentMethodPickerUi();
