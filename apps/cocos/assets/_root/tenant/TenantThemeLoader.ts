export type TenantThemeLoaderDecision = {
  allowed: boolean;
  reason: string;
  auditEvent: string;
  tenantId: string;
...
export class TenantThemeLoader {
  ...
  evaluate(input: { tenantId?: string; audience?: '13+' | 'under-13'; enabled?: boolean; unsafe?: boolean }): TenantThemeLoaderDecision {
...
export const tenantThemeLoader = new TenantThemeLoader();
