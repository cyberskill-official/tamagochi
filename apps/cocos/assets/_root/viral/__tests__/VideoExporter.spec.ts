export type VideoExporterSpecDecision = {
  allowed: boolean;
  reason: string;
  auditEvent: string;
  tenantId: string;
...
export class VideoExporterSpec {
  readonly kind = 'media';

  evaluate(input: { tenantId?: string; audience?: '13+' | 'under-13'; enabled?: boolean; unsafe?: boolean }): VideoExporterSpecDecision {
...
export const videoExporterSpec = new VideoExporterSpec();
