export type TutorialDismissDecision = {
  allowed: boolean;
  reason: string;
  auditEvent: string;
  tenantId: string;
...
export class TutorialDismiss {
  readonly kind = 'media';

  evaluate(input: { tenantId?: string; audience?: '13+' | 'under-13'; enabled?: boolean; unsafe?: boolean }): TutorialDismissDecision {
...
export const tutorialDismiss = new TutorialDismiss();
