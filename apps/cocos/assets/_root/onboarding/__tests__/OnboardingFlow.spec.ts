export type OnboardingFlowSpecDecision = {
  allowed: boolean;
  reason: string;
  auditEvent: string;
  tenantId: string;
...
export class OnboardingFlowSpec {
  ...
  evaluate(input: { tenantId?: string; audience?: '13+' | 'under-13'; enabled?: boolean; unsafe?: boolean }): OnboardingFlowSpecDecision {
...
export const onboardingFlowSpec = new OnboardingFlowSpec();
