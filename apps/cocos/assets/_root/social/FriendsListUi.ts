export type FriendsListUiDecision = {
  allowed: boolean;
  reason: string;
  auditEvent: string;
  tenantId: string;
...
export class FriendsListUi {
  ...
  evaluate(input: { tenantId?: string; audience?: '13+' | 'under-13'; enabled?: boolean; unsafe?: boolean }): FriendsListUiDecision {
...
export const friendsListUi = new FriendsListUi();
