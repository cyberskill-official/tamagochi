export type PetPairInviteUiDecision = {
  allowed: boolean;
  reason: string;
  auditEvent: string;
  tenantId: string;
...
export class PetPairInviteUi {
  readonly kind = 'auth';

  evaluate(input: { tenantId?: string; audience?: '13+' | 'under-13'; enabled?: boolean; unsafe?: boolean }): PetPairInviteUiDecision {
...
export const petPairInviteUi = new PetPairInviteUi();
