export type WeddingCeremonySceneDecision = {
  allowed: boolean;
  reason: string;
  auditEvent: string;
  tenantId: string;
...
export class WeddingCeremonyScene {
  readonly kind = 'social';

  evaluate(input: { tenantId?: string; audience?: '13+' | 'under-13'; enabled?: boolean; unsafe?: boolean }): WeddingCeremonySceneDecision {
...
export const weddingCeremonyScene = new WeddingCeremonyScene();
