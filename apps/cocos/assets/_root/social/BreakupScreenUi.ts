export type BreakupScreenUiDecision = {
  allowed: boolean;
  reason: string;
  auditEvent: string;
  tenantId: string;
...
export class BreakupScreenUi {
  readonly kind = 'social';

  evaluate(input: { tenantId?: string; audience?: '13+' | 'under-13'; enabled?: boolean; unsafe?: boolean }): BreakupScreenUiDecision {
...
export const breakupScreenUi = new BreakupScreenUi();
