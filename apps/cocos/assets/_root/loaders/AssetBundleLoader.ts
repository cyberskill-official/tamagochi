export type AssetBundleLoaderDecision = {
  allowed: boolean;
  reason: string;
  auditEvent: string;
  tenantId: string;
...
export class AssetBundleLoader {
  ...
  evaluate(input: { tenantId?: string; audience?: '13+' | 'under-13'; enabled?: boolean; unsafe?: boolean }): AssetBundleLoaderDecision {
...
export const assetBundleLoader = new AssetBundleLoader();
