export type RewardedVideoUiDecision = {
  allowed: boolean;
  reason: string;
  auditEvent: string;
  tenantId: string;
...
export class RewardedVideoUi {
  readonly kind = 'media';

  evaluate(input: { tenantId?: string; audience?: '13+' | 'under-13'; enabled?: boolean; unsafe?: boolean }): RewardedVideoUiDecision {
...
export const rewardedVideoUi = new RewardedVideoUi();
