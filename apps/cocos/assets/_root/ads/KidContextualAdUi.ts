export type KidContextualAdUiDecision = {
  allowed: boolean;
  reason: string;
  auditEvent: string;
  tenantId: string;
...
export class KidContextualAdUi {
  readonly kind = 'economy';

  evaluate(input: { tenantId?: string; audience?: '13+' | 'under-13'; enabled?: boolean; unsafe?: boolean }): KidContextualAdUiDecision {
...
export const kidContextualAdUi = new KidContextualAdUi();
