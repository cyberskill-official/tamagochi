export type VideoCaptureSpecDecision = {
  allowed: boolean;
  reason: string;
  auditEvent: string;
  tenantId: string;
...
export class VideoCaptureSpec {
  readonly kind = 'media';

  evaluate(input: { tenantId?: string; audience?: '13+' | 'under-13'; enabled?: boolean; unsafe?: boolean }): VideoCaptureSpecDecision {
...
export const videoCaptureSpec = new VideoCaptureSpec();
