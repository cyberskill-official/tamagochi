...
export class ArSession {
  ...
  evaluate(input: { tenantId?: string; audience?: '13+' | 'under-13'; enabled?: boolean; unsafe?: boolean }): ArSessionDecision {
...
export const arSession = new ArSession();
