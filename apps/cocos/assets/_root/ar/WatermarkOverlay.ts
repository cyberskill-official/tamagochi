export type WatermarkOverlayDecision = {
  allowed: boolean;
  reason: string;
  auditEvent: string;
  tenantId: string;
...
export class WatermarkOverlay {
  ...
  evaluate(input: { tenantId?: string; audience?: '13+' | 'under-13'; enabled?: boolean; unsafe?: boolean }): WatermarkOverlayDecision {
...
export const watermarkOverlay = new WatermarkOverlay();
