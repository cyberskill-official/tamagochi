export type EvolutionFlowDecision = {
  allowed: boolean;
  reason: string;
  auditEvent: string;
  tenantId: string;
...
export class EvolutionFlow {
  ...
  evaluate(input: { tenantId?: string; audience?: '13+' | 'under-13'; enabled?: boolean; unsafe?: boolean }): EvolutionFlowDecision {
...
export const evolutionFlow = new EvolutionFlow();
